...
//FORMS
  function forms(){
    ...
    //'+38(999) 999 9999'
    //'+375(99)999-99-99'
    //'a{3,1000}' Ñ‚Ð¾Ð»ÑŒÐºÐ¾ Ð±ÑƒÐºÐ²Ñ‹ Ð¼Ð¸Ð½Ð¸Ð¼ÑƒÐ¼ 3
    //'9{3,1000}' Ñ‚Ð¾Ð»ÑŒÐºÐ¾ Ñ†Ð¸Ñ„Ñ€Ñ‹ Ð¼Ð¸Ð½Ð¸Ð¼ÑƒÐ¼ 3
...
//VALIDATE FORMS
  ...
  function formValidate(input){
    ...
    if(input.hasClass('name')){
      if(!(/^[Ð-Ð¯Ð°-Ña-zA-Z-]+( [Ð-Ð¯Ð°-Ña-zA-Z-]+)$/.test(input.val()))){
        er++;
        addError(input);
      }
    }
  ...
  function formLoad(){
    ...
    $('.popup-message .popup-body').append('<div class="popup-loading"><div class="popup-loading__title">Ð˜Ð´ÐµÑ‚ Ð·Ð°Ð³Ñ€ÑƒÐ·ÐºÐ°...</div><div class="popup-loading__icon"></div></div>');
...
//Ð¡Ð°Ð¼Ð° Ð½Ð°Ð¿Ð¸ÑÐ°Ð»Ð° Ð´Ð»Ñ ÐºÑ€ÐµÑÑ‚Ð¸ÐºÐ°
